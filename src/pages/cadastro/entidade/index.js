        ...
        <form onSubmit={this.salvar}>
          ...
          <div className="form-row">
            ...
            <div className="form-group col-md-3">
              ...
              <select name="sexo" id="inputState" className="form-control">
            ...
            <div className="form-group col-md-3">
              ...
              <select name="estado_civil" id="inputState" className="form-control">
                <option>Selecione...</option>
            ...
            <div className="form-group col-md-3">
              ...
              <select name="cargo" id="inputState" className="form-control">
                <option>Selecione...</option>
