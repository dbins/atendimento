...
class Cadastro extends Component {
  ...
  componentDidMount(){
    ...
    const { cadastroClienteRequest, enderecoRequest, telefoneRequest } = this.props;
    const usuario = this.props.match.params.id;
    enderecoRequest(usuario);
    telefoneRequest(usuario);
    cadastroClienteRequest(usuario);
  }
  ...
  render() {
    ...
    const usuario = parseInt(this.props.match.params.id);
    return (
      <div>
