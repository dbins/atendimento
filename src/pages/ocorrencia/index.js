...
class Ocorrencia extends Component {
  ...
  componentDidMount(){
    ...
    const { ocorrencia, ocorrenciasAssuntoRequest, ocorrenciasStatusRequest, ocorrenciasEncaminhadaRequest, ocorrenciasTipoRequest, ocorrenciasDetalheRequest } = this.props;
    const usuario = 0;
    const codigo_ocorrencia = 0;
  ...
  salvar = e => {
    ...
    const {  tipo, assunto, status, encaminhar, resposta} = this.state;
    const { ocorrenciasAdicionarRequest } = this.props;
    let continuar = true;
    let mensagem = "";
          ...
          <form onSubmit={this.salvar}>
            ...
            <div className="form-row">
              ...
              <div className="form-group col-md-4">
                ...
                <select name="encamnhar" id="encaminhar" className="form-control"  onChange={this.alterar}>
                  <option>Selecione...</option>
