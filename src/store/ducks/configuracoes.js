...
export const Creators = {
  configuracoesCadastrosGeraisRequest: (email, password) => ({
  ...
  configuracoesCadastrosGeraisCombosRequest: (email, password) => ({
  ...
  configuracoesAcoesPerguntasRequest: (email, password) => ({
  ...
  configuracoesAcoesOpcoesRequest: (email, password) => ({
